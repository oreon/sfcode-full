...
public abstract class ExamActionBase extends BaseAction<Exam>
	...
	protected List<org.wc.trackrite.onepack.Question> listQuestions;

	void initListQuestions() {
		listQuestions = new ArrayList<org.wc.trackrite.onepack.Question>();
	...
	public List<org.wc.trackrite.onepack.Question> getListQuestions() {
	...
	public void setListQuestions(
			List<org.wc.trackrite.onepack.Question> listQuestions) {
