...
import org.wc.trackrite.onepack.Choice;
...
public abstract class QuestionActionBase extends BaseAction<Question>
	...
	protected List<org.wc.trackrite.onepack.Choice> listChoices;

	void initListChoices() {
		listChoices = new ArrayList<org.wc.trackrite.onepack.Choice>();
	...
	public List<org.wc.trackrite.onepack.Choice> getListChoices() {
		if (listChoices == null)
			initListChoices();
		return listChoices;
	}

	public void setListChoices(List<org.wc.trackrite.onepack.Choice> listChoices) {
