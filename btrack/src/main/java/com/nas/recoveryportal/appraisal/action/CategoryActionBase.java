...
import com.nas.recoveryportal.appraisal.Category;
...
public class CategoryActionBase extends BaseAction<Category>
	...
	com.nas.recoveryportal.appraisal.action.CategoryAction parentAction;
	...
	public void wire() {
		getInstance();
		com.nas.recoveryportal.appraisal.Category parent = parentAction
				.getDefinedInstance();
		if (parent != null) {
