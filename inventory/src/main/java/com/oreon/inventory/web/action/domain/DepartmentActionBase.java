...
public abstract class DepartmentActionBase extends BaseAction<Department>
	...
	com.oreon.inventory.web.action.domain.EmployeeAction employeesAction;
	...
	public com.oreon.inventory.domain.Department findByUnqName(String name) {
	...
	public void updateAssociations() {
		...
		com.oreon.inventory.domain.Employee employees = (com.oreon.inventory.domain.Employee) org.jboss.seam.Component
	...
	protected List<com.oreon.inventory.domain.Employee> listEmployees = new ArrayList<com.oreon.inventory.domain.Employee>();
	...
	public List<com.oreon.inventory.domain.Employee> getListEmployees() {
	...
	public void setListEmployees(
			List<com.oreon.inventory.domain.Employee> listEmployees) {
