...
public abstract class AppUserListQueryBase extends BaseQuery<AppUser, Long> {
	...
	private com.pcas.datapkg.users.AppRole appRolesToSearch;

	public void setAppRolesToSearch(
			com.pcas.datapkg.users.AppRole appRoleToSearch) {
		this.appRolesToSearch = appRoleToSearch;
	}

	public com.pcas.datapkg.users.AppRole getAppRolesToSearch() {
