...
public abstract class CustomReportListQueryBase
	...
	private com.pcas.datapkg.customReports.MetaField fieldsToSearch;

	public void setFieldsToSearch(
			com.pcas.datapkg.customReports.MetaField metaFieldToSearch) {
		this.fieldsToSearch = metaFieldToSearch;
	}

	public com.pcas.datapkg.customReports.MetaField getFieldsToSearch() {
		return fieldsToSearch;
	}

	private com.pcas.datapkg.customReports.MetaField groupFieldsToSearch;
	...
	public com.pcas.datapkg.customReports.MetaField getGroupFieldsToSearch() {
