package com.pcas.datapkg.web.action.users;
...
public abstract class AppUserActionBase extends BaseAction<AppUser>
	...
	public com.pcas.datapkg.users.AppUser findByUnqUserName(String userName) {
	...
	protected List<com.pcas.datapkg.users.AppRole> listAppRoles = new ArrayList<com.pcas.datapkg.users.AppRole>();
	...
	public List<com.pcas.datapkg.users.AppRole> getListAppRoles() {
	...
	public void setListAppRoles(
			List<com.pcas.datapkg.users.AppRole> listAppRoles) {
		this.listAppRoles = listAppRoles;
	}

	protected List<com.pcas.datapkg.users.AppRole> listAvailableAppRoles = new ArrayList<com.pcas.datapkg.users.AppRole>();
	...
	@Begin(join = true)
	public List<com.pcas.datapkg.users.AppRole> getListAvailableAppRoles() {
	...
	public void setListAvailableAppRoles(
			List<com.pcas.datapkg.users.AppRole> listAvailableAppRoles) {
