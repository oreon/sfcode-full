...
public abstract class AppRoleListQueryBase extends BaseQuery<AppRole, Long> {
	...
	private com.pcas.datapkg.users.AppUser appUsersToSearch;

	public void setAppUsersToSearch(
			com.pcas.datapkg.users.AppUser appUserToSearch) {
		this.appUsersToSearch = appUserToSearch;
	}

	public com.pcas.datapkg.users.AppUser getAppUsersToSearch() {
