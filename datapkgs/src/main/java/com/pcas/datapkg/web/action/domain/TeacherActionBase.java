...
public abstract class TeacherActionBase extends BaseAction<Teacher>
		implements
	...
	@DataModel
	private List<Teacher> teacherRecordList;
	 ...
	 * @param id
	 */
	public void setTeacherIdForModalDlg(Long id) {
		setId(id);
		clearLists();
		loadAssociations();
	}
	...
	//@Override
	public void setEntity(Teacher t) {
		this.teacher = t;
		loadAssociations();
	}
	...
	protected Teacher createInstance() {
		Teacher instance = super.createInstance();
	...
	public Teacher getDefinedInstance() {
		return (Teacher) (isIdDefined() ? getInstance() : null);
	}

	public void setTeacher(Teacher t) {
		this.teacher = t;
		if (teacher != null)
			setTeacherId(t.getId());
		loadAssociations();
	}
