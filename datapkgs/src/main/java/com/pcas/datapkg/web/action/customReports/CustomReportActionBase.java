...
public abstract class CustomReportActionBase extends BaseAction<CustomReport>
	...
	public com.pcas.datapkg.customReports.CustomReport findByUnqName(String name) {
	...
	protected List<com.pcas.datapkg.customReports.ReportParameter> listReportParameters = new ArrayList<com.pcas.datapkg.customReports.ReportParameter>();
	...
	public List<com.pcas.datapkg.customReports.ReportParameter> getListReportParameters() {
	...
	public void setListReportParameters(
			List<com.pcas.datapkg.customReports.ReportParameter> listReportParameters) {
	...
	protected List<com.pcas.datapkg.customReports.MetaField> listFields = new ArrayList<com.pcas.datapkg.customReports.MetaField>();
	...
	public List<com.pcas.datapkg.customReports.MetaField> getListFields() {
	...
	public void setListFields(
			List<com.pcas.datapkg.customReports.MetaField> listFields) {
		this.listFields = listFields;
	}

	protected List<com.pcas.datapkg.customReports.MetaField> listAvailableFields = new ArrayList<com.pcas.datapkg.customReports.MetaField>();
	...
	@Begin(join = true)
	public List<com.pcas.datapkg.customReports.MetaField> getListAvailableFields() {
	...
	public void setListAvailableFields(
			List<com.pcas.datapkg.customReports.MetaField> listAvailableFields) {
		this.listAvailableFields = listAvailableFields;
	}

	protected List<com.pcas.datapkg.customReports.MetaField> listGroupFields = new ArrayList<com.pcas.datapkg.customReports.MetaField>();
	...
	public List<com.pcas.datapkg.customReports.MetaField> getListGroupFields() {
	...
	public void setListGroupFields(
			List<com.pcas.datapkg.customReports.MetaField> listGroupFields) {
		this.listGroupFields = listGroupFields;
	}

	protected List<com.pcas.datapkg.customReports.MetaField> listAvailableGroupFields = new ArrayList<com.pcas.datapkg.customReports.MetaField>();
	...
	@Begin(join = true)
	public List<com.pcas.datapkg.customReports.MetaField> getListAvailableGroupFields() {
	...
	public void setListAvailableGroupFields(
			List<com.pcas.datapkg.customReports.MetaField> listAvailableGroupFields) {
