...
public abstract class ReportParameterActionBase
	...
	com.pcas.datapkg.web.action.customReports.CustomReportAction customReportAction;
	...
	public void wire() {
		...
		com.pcas.datapkg.customReports.CustomReport customReport = customReportAction
				.getDefinedInstance();
