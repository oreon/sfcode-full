...
public abstract class DepartmentActionBase extends BaseAction<Department>
	...
	com.pcas.datapkg.web.action.domain.EmployeeAction employeesAction;
	...
	public com.pcas.datapkg.domain.Department findByUnqName(String name) {
	...
	public void updateAssociations() {
		...
		com.pcas.datapkg.domain.Employee employees = (com.pcas.datapkg.domain.Employee) org.jboss.seam.Component
