...
@XmlRootElement
public class CustomReport extends BaseEntity implements java.io.Serializable {
	...
	public List<com.pcas.datapkg.customReports.ReportParameter> getListReportParameters() {
		return new ArrayList<com.pcas.datapkg.customReports.ReportParameter>(
				reportParameters);
	}
	...
	public List<String> listSearchableFields() {
		...
		listSearchableFields.add("reportParameters.name");
