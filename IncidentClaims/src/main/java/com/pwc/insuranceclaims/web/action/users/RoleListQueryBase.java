...
public abstract class RoleListQueryBase extends BaseQuery<Role, Long> {
	...
	private com.pwc.insuranceclaims.users.User usersToSearch;

	public void setUsersToSearch(com.pwc.insuranceclaims.users.User userToSearch) {
		this.usersToSearch = userToSearch;
	}

	public com.pwc.insuranceclaims.users.User getUsersToSearch() {
