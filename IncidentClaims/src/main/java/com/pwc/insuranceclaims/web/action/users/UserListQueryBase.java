...
public abstract class UserListQueryBase extends BaseQuery<User, Long> {
	...
	private com.pwc.insuranceclaims.users.Role rolesToSearch;

	public void setRolesToSearch(com.pwc.insuranceclaims.users.Role roleToSearch) {
		this.rolesToSearch = roleToSearch;
	}

	public com.pwc.insuranceclaims.users.Role getRolesToSearch() {
