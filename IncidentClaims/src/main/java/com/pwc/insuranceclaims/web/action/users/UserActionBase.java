package com.pwc.insuranceclaims.web.action.users;
...
public abstract class UserActionBase extends BaseAction<User>
	...
	public com.pwc.insuranceclaims.users.User findByUnqUserName(String userName) {
	...
	protected List<com.pwc.insuranceclaims.users.Role> listRoles = new ArrayList<com.pwc.insuranceclaims.users.Role>();
	...
	public List<com.pwc.insuranceclaims.users.Role> getListRoles() {
	...
	public void setListRoles(List<com.pwc.insuranceclaims.users.Role> listRoles) {
		this.listRoles = listRoles;
	}

	protected List<com.pwc.insuranceclaims.users.Role> listAvailableRoles = new ArrayList<com.pwc.insuranceclaims.users.Role>();
	...
	@Begin(join = true)
	public List<com.pwc.insuranceclaims.users.Role> getListAvailableRoles() {
	...
	public void setListAvailableRoles(
			List<com.pwc.insuranceclaims.users.Role> listAvailableRoles) {
