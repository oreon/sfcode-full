...
public class Role extends BaseEntity implements java.io.Serializable {
	...
	//@Unique(entityName = "com.oreon.phonestore.users.Role", fieldName = "name")
	...
	@Transient
	public List<com.oreon.phonestore.users.User> getListUsers() {
		return new ArrayList<com.oreon.phonestore.users.User>(users);
	}
