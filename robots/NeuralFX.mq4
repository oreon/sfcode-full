...
extern double    Stop  = 85;  
extern double    Limit    = 35;  // fitting with the tester
extern double    Trail = 15;
extern double    Lots = 0.01;



int MAGIC_NUM=33445577;
...
void paintLine()
    ...
    void paintSignal(int value)
  {
   ...
   //placeOrder(OP_BUY, MAGIC_NUM, Limit, Stop, Lots );
   }
   if (value==0) 
   {
