...
import com.prime.view.util.JsfUtil;
import com.prime.view.util.PaginationHelper;
import com.prime.session.DiscountCodeFacade;
...
public class DiscountCodeController {
    ...
    @EJB private com.prime.session.DiscountCodeFacade ejbFacade;
    ...
    public static class DiscountCodeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DiscountCode) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+DiscountCodeController.class.getName());
            }
        }
