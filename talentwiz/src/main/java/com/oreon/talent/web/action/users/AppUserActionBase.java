...
public abstract class AppUserActionBase extends BaseAction<AppUser>
	...
	protected List<com.oreon.talent.users.AppRole> listAppRoles = new ArrayList<com.oreon.talent.users.AppRole>();
	...
	public List<com.oreon.talent.users.AppRole> getListAppRoles() {
	...
	public void setListAppRoles(
			List<com.oreon.talent.users.AppRole> listAppRoles) {
		this.listAppRoles = listAppRoles;
	}

	protected List<com.oreon.talent.users.AppRole> listAvailableAppRoles = new ArrayList<com.oreon.talent.users.AppRole>();
	...
	@Begin(join = true)
	public List<com.oreon.talent.users.AppRole> getListAvailableAppRoles() {
	...
	public void setListAvailableAppRoles(
			List<com.oreon.talent.users.AppRole> listAvailableAppRoles) {
