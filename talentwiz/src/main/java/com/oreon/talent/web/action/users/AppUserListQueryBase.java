...
public abstract class AppUserListQueryBase extends BaseQuery<AppUser, Long> {
	...
	private com.oreon.talent.users.AppRole appRolesToSearch;

	public void setAppRolesToSearch(
			com.oreon.talent.users.AppRole appRoleToSearch) {
		this.appRolesToSearch = appRoleToSearch;
	}

	public com.oreon.talent.users.AppRole getAppRolesToSearch() {
