...
public abstract class EmployeeListQueryBase extends BaseQuery<Employee, Long> {
	...
	private static final String[] RESTRICTIONS = {
			...
			"lower(employee.contactDetails.postalCode) like concat(lower(#{employeeList.employee.contactDetails.postalCode}),'%')",
	...
	public List<Employee> getEmployeesByDepartment(
			com.oreon.talent.domain.Department department) {
		//setMaxResults(10000);
