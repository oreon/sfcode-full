...
public abstract class AppRoleListQueryBase extends BaseQuery<AppRole, Long> {
	...
	private com.oreon.talent.users.AppUser appUsersToSearch;

	public void setAppUsersToSearch(
			com.oreon.talent.users.AppUser appUserToSearch) {
		this.appUsersToSearch = appUserToSearch;
	}

	public com.oreon.talent.users.AppUser getAppUsersToSearch() {
