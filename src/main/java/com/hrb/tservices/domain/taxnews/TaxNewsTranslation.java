...
@Entity
@Table(name = "taxnewstranslation")
@Filter(name = "archiveFilterDef")
@Name("taxNewsTranslation")
@Indexed
@Cache(usage = CacheConcurrencyStrategy.NONE)
@Analyzer(definition = "entityAnalyzer")
@XmlRootElement
public class TaxNewsTranslation extends BusinessEntity
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 142410757L;
