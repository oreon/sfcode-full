...
@Entity
@Table(name = "marketingmessagemetrics")
@Filter(name = "archiveFilterDef")
@Name("marketingMessageMetrics")
@Indexed
@Cache(usage = CacheConcurrencyStrategy.NONE)
@Analyzer(definition = "entityAnalyzer")
@XmlRootElement
public class MarketingMessageMetrics
		extends
			com.hrb.tservices.domain.metrics.BaseMetrics
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 2024712093L;
	...
	@JoinColumn(name = "messageTranslation_id", nullable = false, updatable = true)
	@ContainedIn
	protected MessageTranslation messageTranslation
	...
	public String getSearchData() {
		...
		if (getMessageTranslation() != null)
			builder.append("messageTranslation:"
					+ getMessageTranslation().getDisplayName() + " ");
