...
public class AlbertaTaxValues2011 extends ProvincialTaxValues2011 
{
	public AlbertaTaxValues2011(double L5804_Basic, 
								double L5808_Age,
	...
	{
		return (new StringBuilder(200).append(province.shortName()).append(" [").append(super.toString()).append("]")).toString();
	}
