...
public abstract class AppRoleListQueryBase extends BaseQuery<AppRole, Long> {
	...
	private com.hrb.tservices.domain.users.AppUser appUsersToSearch;

	public void setAppUsersToSearch(
			com.hrb.tservices.domain.users.AppUser appUserToSearch) {
		this.appUsersToSearch = appUserToSearch;
	}

	public com.hrb.tservices.domain.users.AppUser getAppUsersToSearch() {
