...
public abstract class AppUserActionBase extends BaseAction<AppUser>
	...
	public com.hrb.tservices.domain.users.AppUser findByUnqUserName(
			String userName) {
	...
	protected List<com.hrb.tservices.domain.users.AppRole> listAppRoles = new ArrayList<com.hrb.tservices.domain.users.AppRole>();
	...
	public List<com.hrb.tservices.domain.users.AppRole> getListAppRoles() {
	...
	public void setListAppRoles(
			List<com.hrb.tservices.domain.users.AppRole> listAppRoles) {
		this.listAppRoles = listAppRoles;
	}

	protected List<com.hrb.tservices.domain.users.AppRole> listAvailableAppRoles = new ArrayList<com.hrb.tservices.domain.users.AppRole>();
	...
	@Begin(join = true)
	public List<com.hrb.tservices.domain.users.AppRole> getListAvailableAppRoles() {
	...
	public void setListAvailableAppRoles(
			List<com.hrb.tservices.domain.users.AppRole> listAvailableAppRoles) {
