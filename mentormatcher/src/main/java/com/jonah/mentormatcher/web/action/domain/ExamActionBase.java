...
public abstract class ExamActionBase extends BaseAction<Exam>
	...
	public com.jonah.mentormatcher.domain.Exam findByUnqTitle(String title) {
	...
	protected List<com.jonah.mentormatcher.domain.Question> listQuestions = new ArrayList<com.jonah.mentormatcher.domain.Question>();
	...
	public List<com.jonah.mentormatcher.domain.Question> getListQuestions() {
	...
	public void setListQuestions(
			List<com.jonah.mentormatcher.domain.Question> listQuestions) {
