...
public abstract class AppUserListQueryBase extends BaseQuery<AppUser, Long> {
	...
	private com.jonah.mentormatcher.domain.users.AppRole appRolesToSearch;

	public void setAppRolesToSearch(
			com.jonah.mentormatcher.domain.users.AppRole appRoleToSearch) {
		this.appRolesToSearch = appRoleToSearch;
	}

	public com.jonah.mentormatcher.domain.users.AppRole getAppRolesToSearch() {
