...
@XmlRootElement
public class MonthlyFee extends BusinessEntity implements java.io.Serializable {
	...
	public void addGradeFeeItem(GradeFeeItem gradeFeeItem) {
		gradeFeeItem.setMonthlyFee(this);
		this.gradeFeeItems.add(gradeFeeItem);
	}
