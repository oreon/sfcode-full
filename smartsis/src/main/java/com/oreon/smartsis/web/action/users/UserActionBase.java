...
public abstract class UserActionBase extends BaseAction<User>
	...
	public com.oreon.smartsis.users.User findByUnqUserName(String userName) {
		return executeSingleResultNamedQuery("user.findByUnqUserName", userName);
	}

	public com.oreon.smartsis.users.User findByUnqEmail(String email) {
	...
	protected List<com.oreon.smartsis.users.Role> listRoles = new ArrayList<com.oreon.smartsis.users.Role>();
	...
	public List<com.oreon.smartsis.users.Role> getListRoles() {
	...
	public void setListRoles(List<com.oreon.smartsis.users.Role> listRoles) {
		this.listRoles = listRoles;
	}

	protected List<com.oreon.smartsis.users.Role> listAvailableRoles = new ArrayList<com.oreon.smartsis.users.Role>();
	...
	@Begin(join = true)
	public List<com.oreon.smartsis.users.Role> getListAvailableRoles() {
	...
	public void setListAvailableRoles(
			List<com.oreon.smartsis.users.Role> listAvailableRoles) {
