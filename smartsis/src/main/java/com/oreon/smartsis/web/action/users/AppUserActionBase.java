...
public abstract class AppUserActionBase extends BaseAction<AppUser>
	...
	public com.oreon.smartsis.users.AppUser findByUnqUserName(String userName) {
		return executeSingleResultNamedQuery("appUser.findByUnqUserName",
				userName);
	}

	public com.oreon.smartsis.users.AppUser findByUnqEmail(String email) {
	...
	protected List<com.oreon.smartsis.users.AppRole> listAppRoles = new ArrayList<com.oreon.smartsis.users.AppRole>();
	...
	public List<com.oreon.smartsis.users.AppRole> getListAppRoles() {
	...
	public void setListAppRoles(
			List<com.oreon.smartsis.users.AppRole> listAppRoles) {
		this.listAppRoles = listAppRoles;
	}

	protected List<com.oreon.smartsis.users.AppRole> listAvailableAppRoles = new ArrayList<com.oreon.smartsis.users.AppRole>();
	...
	@Begin(join = true)
	public List<com.oreon.smartsis.users.AppRole> getListAvailableAppRoles() {
	...
	public void setListAvailableAppRoles(
			List<com.oreon.smartsis.users.AppRole> listAvailableAppRoles) {
