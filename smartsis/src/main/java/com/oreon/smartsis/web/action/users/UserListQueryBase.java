...
public abstract class UserListQueryBase extends BaseQuery<User, Long> {
	...
	private com.oreon.smartsis.users.Role rolesToSearch;

	public void setRolesToSearch(com.oreon.smartsis.users.Role roleToSearch) {
		this.rolesToSearch = roleToSearch;
	}

	public com.oreon.smartsis.users.Role getRolesToSearch() {
