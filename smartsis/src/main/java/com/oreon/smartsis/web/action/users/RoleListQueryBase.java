...
public abstract class RoleListQueryBase extends BaseQuery<Role, Long> {
	...
	private com.oreon.smartsis.users.User usersToSearch;

	public void setUsersToSearch(com.oreon.smartsis.users.User userToSearch) {
		this.usersToSearch = userToSearch;
	}

	public com.oreon.smartsis.users.User getUsersToSearch() {
