...
public abstract class GradeSubjectActionBase extends BaseAction<GradeSubject>
	...
	public void wire() {
		...
		com.oreon.smartsis.domain.Subject subject = subjectAction
				.getDefinedInstance();
	...
	protected List<com.oreon.smartsis.domain.CourseDocuments> listCourseDocumentses = new ArrayList<com.oreon.smartsis.domain.CourseDocuments>();
	...
	public void setListCourseDocumentses(
			List<com.oreon.smartsis.domain.CourseDocuments> listCourseDocumentses) {
