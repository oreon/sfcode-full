...
public abstract class AppRoleListQueryBase extends BaseQuery<AppRole, Long> {
	...
	private com.oreon.smartsis.users.AppUser appUsersToSearch;

	public void setAppUsersToSearch(
			com.oreon.smartsis.users.AppUser appUserToSearch) {
		this.appUsersToSearch = appUserToSearch;
	}

	public com.oreon.smartsis.users.AppUser getAppUsersToSearch() {
