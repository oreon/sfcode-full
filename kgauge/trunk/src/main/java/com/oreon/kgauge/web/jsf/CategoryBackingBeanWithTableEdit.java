...
public class CategoryBackingBeanWithTableEdit extends BaseBackingBean<Category> {
	...
	private DataModel children = new ListDataModel();
	...
	public void setChildren(DataModel children) {
		System.out.println("Set children called "  + ((Collection)children.getWrappedData()).size() );
