...
public class ExamTestDataFactory extends AbstractTestDataFactory<Exam> {
	...
	public Exam createExamOne() {
		...
		try {
			...
			exam.setName("Wilson");
			exam.setQuestions(6666);
			exam.setDuration(8200);
			exam.setPrice(80.01);
			exam
	...
	public Exam createExamTwo() {
		...
		try {
			...
			exam.setName("alpha");
			exam.setQuestions(8048);
			exam.setDuration(4453);
			exam.setPrice(3.05);
			exam
	...
	public Exam createExamThree() {
		...
		try {
			...
			exam.setName("Wilson");
			exam.setQuestions(1662);
			exam.setDuration(761);
			exam.setPrice(48.49);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreOnlyForCorrectAnswers);
	...
	public Exam createExamFour() {
		...
		try {
			...
			exam.setName("Mark");
			exam.setQuestions(3834);
			exam.setDuration(9080);
			exam.setPrice(49.65);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
	...
	public Exam createExamFive() {
		...
		try {
			...
			exam.setName("zeta");
			exam.setQuestions(4335);
			exam.setDuration(9932);
			exam.setPrice(0.31);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
			exam.setExamStatus(com.oreon.kgauge.domain.ExamStatus.INACTIVE);
