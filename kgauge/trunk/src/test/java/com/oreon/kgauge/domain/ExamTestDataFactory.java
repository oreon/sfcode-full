...
public class ExamTestDataFactory extends AbstractTestDataFactory<Exam> {
	...
	public Exam createExamOne() {
		...
		try {
			...
			exam.setQuestions(5965);
			exam.setDuration(6180);
			exam.setPrice(37.76);
			exam
	...
	public Exam createExamTwo() {
		...
		try {
			...
			exam.setName("pi");
			exam.setQuestions(8805);
			exam.setDuration(1893);
			exam.setPrice(52.68);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreOnlyForCorrectAnswers);
	...
	public Exam createExamThree() {
		...
		try {
			...
			exam.setDescription("delta");
			exam.setName("gamma");
			exam.setQuestions(1594);
			exam.setDuration(1619);
			exam.setPrice(20.74);
			exam
	...
	public Exam createExamFour() {
		...
		try {
			...
			exam.setQuestions(9099);
			exam.setDuration(1065);
			exam.setPrice(89.13);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
	...
	public Exam createExamFive() {
		...
		try {
			...
			exam.setName("theta");
			exam.setQuestions(6020);
			exam.setDuration(1454);
			exam.setPrice(21.63);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
