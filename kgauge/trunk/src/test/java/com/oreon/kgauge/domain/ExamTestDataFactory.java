...
public class ExamTestDataFactory extends AbstractTestDataFactory<Exam> {
	...
	public Exam createExamOne() {
		...
		try {
			...
			exam.setName("gamma");
			exam.setQuestions(8388);
			exam.setDuration(6358);
			exam.setPrice(62.63);
			exam
	...
	public Exam createExamTwo() {
		...
		try {
			...
			exam.setName("beta");
			exam.setQuestions(6286);
			exam.setDuration(1288);
			exam.setPrice(46.01);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
	...
	public Exam createExamThree() {
		...
		try {
			...
			exam.setName("theta");
			exam.setQuestions(6757);
			exam.setDuration(9323);
			exam.setPrice(90.33);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
	...
	public Exam createExamFour() {
		...
		try {
			...
			exam.setName("theta");
			exam.setQuestions(2447);
			exam.setDuration(7462);
			exam.setPrice(34.27);
			exam
	...
	public Exam createExamFive() {
		...
		try {
			...
			exam.setDescription("Eric");
			exam.setName("pi");
			exam.setQuestions(6317);
			exam.setDuration(6831);
			exam.setPrice(1.61);
			exam
					.setScoringStrategy(com.oreon.kgauge.domain.ScoringType.ScoreForAllAnswers);
