...
public class Sponsoror extends org.wc.mytapovan.domain.Person
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 868887093L;

	@OneToMany(mappedBy = "sponsoror", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JoinColumn(name = "sponsoror_ID", nullable = true)
