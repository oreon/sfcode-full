...
public class Sponsorship extends BusinessEntity implements java.io.Serializable {
	...
	@JoinColumn(name = "sponsoror_id", nullable = false, updatable = true)
	@ContainedIn
	protected Sponsoror sponsoror;
	...
	public void setSponsoror(Sponsoror sponsoror) {
		this.sponsoror = sponsoror;
	}
