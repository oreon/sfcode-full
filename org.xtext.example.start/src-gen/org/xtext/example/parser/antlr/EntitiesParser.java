...
public class EntitiesParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		org.xtext.example.parser.antlr.internal.InternalEntitiesLexer lexer = new org.xtext.example.parser.antlr.internal.InternalEntitiesLexer(in);
		XtextTokenStream stream = new XtextTokenStream(lexer, antlrTokenDefProvider);
		stream.setInitialHiddenTokens("RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT");
		org.xtext.example.parser.antlr.internal.InternalEntitiesParser parser = new org.xtext.example.parser.antlr.internal.InternalEntitiesParser(
