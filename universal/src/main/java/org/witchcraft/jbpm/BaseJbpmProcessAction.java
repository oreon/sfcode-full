...
public class BaseJbpmProcessAction {
    ...
    public String getTaskForm() {
        ...
        return "/admin/tasks/taskForms/" + task.getProcessInstance().getProcessDefinition().getName() + "/" + task.getName() + "TaskForm.xhtml";
    }
    ...
    public String makeDecision() {
        ...
        try {
            ...
            loadInstance();
            if (transName == null) {
                transName = ServletContexts.getInstance().getRequest().getParameter("transName");
            }
    ...
    public List<Comment> getComments() {
        ...
        Collections.sort((List<Comment>) cmts, new Comparator()  {

            public int compare(Object com1, Object com2) {
                Comment c1 = (Comment) com1;
                Comment c2 = (Comment) com2;
    ...
    public List<org.jbpm.graph.def.Transition> getTaskTransitions() {
        List<org.jbpm.graph.def.Transition> transitions = task.getAvailableTransitions();
        Collections.sort((List<org.jbpm.graph.def.Transition>) transitions, new Comparator()  {
