...
public abstract class DepartmentActionBase extends BaseAction<Department>
	...
	protected List<com.oreon.tapovan.domain.Employee> listEmployees = new ArrayList<com.oreon.tapovan.domain.Employee>();
	...
	public List<com.oreon.tapovan.domain.Employee> getListEmployees() {
	...
	public void setListEmployees(
			List<com.oreon.tapovan.domain.Employee> listEmployees) {
