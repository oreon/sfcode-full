...
@Entity
@Table(name = "propertymanagementcompany")
...
public class PropertyManagementCompany
		extends
			com.nas.recovery.domain.loan.Company
		implements
	...
	public void setPropertyManagers(Set<PropertyManager> propertyManagers) {
		this.propertyManagers = propertyManagers;
	}

	public Set<PropertyManager> getPropertyManagers() {
