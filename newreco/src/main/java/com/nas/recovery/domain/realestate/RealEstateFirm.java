...
public class RealEstateFirm extends com.nas.recovery.domain.loan.Company
		implements
	...
	@IndexedEmbedded
	private Set<MasterAgent> masterAgents = new HashSet<MasterAgent>();

	public void setMasterAgents(Set<MasterAgent> masterAgents) {
		this.masterAgents = masterAgents;
	}

	public Set<MasterAgent> getMasterAgents() {
		return masterAgents;
	}
