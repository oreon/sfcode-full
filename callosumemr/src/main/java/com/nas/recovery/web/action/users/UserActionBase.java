...
public abstract class UserActionBase extends BaseAction<User>
	...
	public com.oreon.callosum.users.User findByUnqUserName(String userName) {
	...
	public void setListRoles(List<com.oreon.callosum.users.Role> listRoles) {
	...
	public void setListAvailableRoles(
			List<com.oreon.callosum.users.Role> listAvailableRoles) {
