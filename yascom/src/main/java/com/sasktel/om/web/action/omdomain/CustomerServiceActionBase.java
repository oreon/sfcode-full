...
import com.sasktel.om.omdomain.CustomerService;
...
public abstract class CustomerServiceActionBase
		extends
			BaseAction<CustomerService> implements java.io.Serializable {

	@Inject
	com.sasktel.om.web.action.omdomain.CustomerServiceSpecAction customerServiceSpecAction;

	protected Predicate[] getSearchPredicates(Root<CustomerService> root) {
	...
	public CustomerService createInstance() {
