package com.sasktel.om.web.action.domain;

import com.sasktel.om.domain.Department;
...
import com.sasktel.om.domain.Employee;
...
public abstract class DepartmentActionBase extends BaseAction<Department>
	...
	protected List<com.sasktel.om.domain.Employee> listEmployees = new ArrayList<com.sasktel.om.domain.Employee>();
	...
	public List<com.sasktel.om.domain.Employee> getListEmployees() {
		return listEmployees;
	}

	public void setListEmployees(
			List<com.sasktel.om.domain.Employee> listEmployees) {
	...
	public com.sasktel.om.domain.Department findByUnqName(String name) {
