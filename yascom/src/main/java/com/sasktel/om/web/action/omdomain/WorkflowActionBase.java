...
import com.sasktel.om.omdomain.Workflow;
...
public abstract class WorkflowActionBase extends BaseAction<Workflow>
		implements
			java.io.Serializable {

	protected Predicate[] getSearchPredicates(Root<Workflow> root) {
	...
	public com.sasktel.om.omdomain.Workflow findByUnqName(String name) {
		return executeSingleResultNamedQuery("workflow.findByUnqName", name);
	}
