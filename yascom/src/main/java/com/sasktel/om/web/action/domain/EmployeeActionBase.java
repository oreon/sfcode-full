...
public abstract class EmployeeActionBase
		extends
			com.sasktel.om.web.action.domain.PersonAction<Employee>
		implements
			java.io.Serializable {

	@Inject
	com.sasktel.om.web.action.domain.DepartmentAction departmentAction;
	...
	public com.sasktel.om.domain.Employee findByPhone(String phone) {
