...
public abstract class AppUserActionBase extends BaseAction<AppUser>
	...
	@Inject
	com.sasktel.om.web.action.users.AppRoleAction appRoleAction;
	...
	protected DualListModel<com.sasktel.om.users.AppRole> listAppRoles = new DualListModel<com.sasktel.om.users.AppRole>();

	void initListAppRoles() {

		List<com.sasktel.om.users.AppRole> availableappRoles = appRoleAction
				.getAll();
		List<com.sasktel.om.users.AppRole> currentappRoles = getEntity() != null
				? ViewUtils.asList(getEntity().getAppRoles())
				: new ArrayList<com.sasktel.om.users.AppRole>();

		if (availableappRoles == null)
			availableappRoles = new ArrayList<com.sasktel.om.users.AppRole>();
		if (getEntity() != null)
			availableappRoles.removeAll(getEntity().getAppRoles());

		listAppRoles = new DualListModel<com.sasktel.om.users.AppRole>(
				availableappRoles, currentappRoles);
	}

	public DualListModel<com.sasktel.om.users.AppRole> getListAppRoles() {
		return listAppRoles;
	}

	public void setListAppRoles(
			DualListModel<com.sasktel.om.users.AppRole> listAppRoles) {
	...
	public com.sasktel.om.users.AppUser findByUnqUserName(String userName) {
