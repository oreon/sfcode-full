...
import com.sasktel.om.domain.Exam;
...
import com.sasktel.om.domain.Question;
...
public abstract class ExamActionBase extends BaseAction<Exam>
	...
	protected List<com.sasktel.om.domain.Question> listQuestions = new ArrayList<com.sasktel.om.domain.Question>();
	...
	public void setListQuestions(
			List<com.sasktel.om.domain.Question> listQuestions) {
	...
	public com.sasktel.om.domain.Exam findByUnqTitle(String title) {
